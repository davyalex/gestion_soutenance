@extends('admin.app')
    ...
    @section('title', ' Admin | Liste departement')
            ...
            @endif        
              ...
              <table class="table table-responsive table-advance table-hover">
                <tbody> 
                  ...
                  <tr>
                    <td></td>
                    <td>{{ $departements->lib_departement }}</td>                                         
                      <div class="btn-group">
                        <td><a class="btn btn-success" href="{{ route('departement.edit', $departements->id) }}"><i class="fa fa-pencil"></i></a></td>                        
                        <td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Ajouter un departememnt</h4>
                  </div>
                  <div class="modal-body">
                    <form role="form" method="post" action="{{ route('departement.store') }}">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputlibelle">Libellé</label>
                        <input type="text" class="form-control"  name="lib_departement" placeholder="Entrer nom departement">
                      </div>                    
