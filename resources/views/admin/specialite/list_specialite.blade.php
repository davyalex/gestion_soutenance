@extends('admin.app')
    ...
    @section('title', ' Admin | Liste specialite')
            ...
            @endif
              ...
              <table class="table table-responsive table-advance table-hover">
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td>{{ $specialites->lib_specialite }}</td>                                         
                      <div class="btn-group">
                        <td><a class="btn btn-success" href="{{ route('specialite.edit', $specialites->id) }}"><i class="fa fa-pencil"></i></a></td>                        
                        <td>
                          <form action="{{ route('specialite.destroy', $specialites->id) }}" method="post">
                            @csrf
                            @method('DELETE')
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" method="post" action="{{ route('specialite.store') }}">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputlibelle">Libellé</label>
                        <input type="text" class="form-control"  name="lib_specialite" placeholder="Entrer nom specialite">
                      </div>                    
