...
@section('title','Etudiant | Liste des soutenance programmé')
    ...
    <tbody>
      <tr>
        @foreach ($soutenance as $key=>$soutenances)       
            ...
            <div class="btn-group">
               <td><a class="btn btn-warning" href="{{ route('etudiant_search.show',$soutenances->id) }}"><i class="fa fa-eye"></i></a></td>                        
               <td>
